%% Experiment 20 - 2D Lu-sin(au)=0, single interior point
% Repeating Exp16 in 2D and combining with Exp15
...
figure(1)
contourf(testu2,aa,Gp'+repmat(testu2,ind,1),[0,0])%,[-10,-1,0,1,10,100])
% contourf(testu2,aa,Gp')