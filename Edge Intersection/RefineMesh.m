...
for j=1:size(T,1),               % updating neighboring information
  ...
  if ne(1)==size(T,1)+1          % real boundary
    Tr(4*(j-1)+1,4)=size(Tr,1)+1;
    Tr(4*(j-1)+3,5)=size(Tr,1)+1;
  else  
    id=find(T(ne(1),1:3)==i(2));
    if id==1
      Tr(4*(j-1)+1,4)=4*(ne(1)-1)+3;
      Tr(4*(j-1)+3,5)=4*(ne(1)-1)+1;
    elseif id==2
      Tr(4*(j-1)+1,4)=4*(ne(1)-1)+4;
      Tr(4*(j-1)+3,5)=4*(ne(1)-1)+3;
    else
      Tr(4*(j-1)+1,4)=4*(ne(1)-1)+1;
      Tr(4*(j-1)+3,5)=4*(ne(1)-1)+4;
    end;
  end;
  if ne(2)==size(T,1)+1          % real boundary
    Tr(4*(j-1)+3,6)=size(Tr,1)+1;
    Tr(4*(j-1)+4,4)=size(Tr,1)+1;
  else    
    id=find(T(ne(2),1:3)==i(3));
    if id==1
      Tr(4*(j-1)+3,6)=4*(ne(2)-1)+3;
      Tr(4*(j-1)+4,4)=4*(ne(2)-1)+1;
    elseif id==2
      Tr(4*(j-1)+3,6)=4*(ne(2)-1)+4;
      Tr(4*(j-1)+4,4)=4*(ne(2)-1)+3;
    else
      Tr(4*(j-1)+3,6)=4*(ne(2)-1)+1;
      Tr(4*(j-1)+4,4)=4*(ne(2)-1)+4;
    end;
  end;
  if ne(3)==size(T,1)+1          % real boundary
    Tr(4*(j-1)+4,5)=size(Tr,1)+1;
    Tr(4*(j-1)+1,6)=size(Tr,1)+1;
  else
    id=find(T(ne(3),1:3)==i(1));
    if id==1
      Tr(4*(j-1)+4,5)=4*(ne(3)-1)+3;
      Tr(4*(j-1)+1,6)=4*(ne(3)-1)+1;
    elseif id==2
      Tr(4*(j-1)+4,5)=4*(ne(3)-1)+4;
      Tr(4*(j-1)+1,6)=4*(ne(3)-1)+3;
    else
      Tr(4*(j-1)+4,5)=4*(ne(3)-1)+1;
      Tr(4*(j-1)+1,6)=4*(ne(3)-1)+4;
    end;
  end;
end;
